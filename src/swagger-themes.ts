...
export function DraculaTheme() {
  return `/* https://github.com/oqo0/swagger-dark-theme */
...
.swagger-ui .opblock {
    ...
    border-radius: 4px;
    box-shadow: 0 0 3px hsla(0, 0%, 100%, .19);
    margin: 0 0 15px
}
...
.swagger-ui .opblock .opblock-section-header {
    ...
    box-shadow: 0 1px 2px hsla(0, 0%, 100%, .1);
    display: flex;
    min-height: 50px;
    padding: 8px 20px
}
...
.swagger-ui .scheme-container {
    background: #303030;
    box-shadow: 0 1px 2px 0 hsla(0, 0%, 100%, .15);
    margin: 0 0 20px;
    padding: 30px 0
}
...
.swagger-ui .loading-container .loading:before {
    ...
    backface-visibility: hidden;
    border: 2px solid hsla(0, 0%, 67%, .1);
    border-radius: 100%;
...
.swagger-ui select {
    ...
    -moz-appearance: none;
    appearance: none;
    background: #555 url("data:image/svg+xml;charset=utf-8,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 20 20\"><path d=\"M13.418 7.859a.695.695 0 0 1 .978 0 .68.68 0 0 1 0 .969l-3.908 3.83a.697.697 0 0 1-.979 0l-3.908-3.83a.68.68 0 0 1 0-.969.695.695 0 0 1 .978 0L10 11l3.418-3.141z\"/></svg>") right 10px center no-repeat;
...
.swagger-ui .checkbox input[type=checkbox]:checked+label>.item {
    background: #505050 url("data:image/svg+xml;charset=utf-8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"10\" height=\"8\" viewBox=\"3 7 10 8\"><path fill=\"%2341474E\" fill-rule=\"evenodd\" d=\"M6.333 15 3 11.667l1.333-1.334 2 2L11.667 7 13 8.333z\"/></svg>") 50% no-repeat
}

.swagger-ui select {
    background: #555 url("data:image/svg+xml;charset=utf-8,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 20 20\"><path fill=\"%23fff\" d=\"M13.418 7.859a.695.695 0 0 1 .978 0 .68.68 0 0 1 0 .969l-3.908 3.83a.697.697 0 0 1-.979 0l-3.908-3.83a.68.68 0 0 1 0-.969.695.695 0 0 1 .978 0L10 11l3.418-3.141z\"/></svg>") right 10px center no-repeat
}
...
.swagger-ui .checkbox input[type=checkbox]:checked+label>.item {
    background: #505050 url("data:image/svg+xml;charset=utf-8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"10\" height=\"8\" viewBox=\"3 7 10 8\"><path fill=\"%23cfcfcf\" fill-rule=\"evenodd\" d=\"M6.333 15 3 11.667l1.333-1.334 2 2L11.667 7 13 8.333z\"/></svg>") 50% no-repeat
}
...
.swagger-ui .dialog-ux .modal-ux {
    ...
    border-radius: 4px;
    box-shadow: 0 10px 30px 0 hsla(0, 0%, 100%, .2);
    left: 50%;
    max-width: 650px;
    min-width: 300px;
    position: absolute;
...
.swagger-ui section.models {
    border: 1px solid hsla(44, 16%, 73%, .3);
    border-radius: 4px;
    margin: 30px 0
}
...
.swagger-ui section.models.is-open h4 {
    border-bottom: 1px solid hsla(44, 16%, 73%, .3);
    margin: 0 0 5px
}
...
.swagger-ui .model-toggle:after {
    background: url("data:image/svg+xml;charset=utf-8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\"><path fill=\"%23fff\" d=\"M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z\"/></svg>") 50% no-repeat
}
...
.swagger-ui table thead tr th {
    border-bottom: 1px solid hsla(44, 16%, 73%, .2);
    color: #c4beae;
    font-family: sans-serif;
    font-size: 12px;
    font-weight: 700;
